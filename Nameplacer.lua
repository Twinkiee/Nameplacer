...
------------------------------------------------------------------------
function Nameplacer:AddUnit(strUnitName, wndUnitGrid, nVerticalOffset)

    self:AddUnitRow(strUnitName, wndUnitGrid, nVerticalOffset)
...
------------------------------------------------------------------------
function Nameplacer:AddUnitRow(strUnitName, wndUnitGrid, nVerticalOffset)
    ...
    if (nVerticalOffset) then
        self:UpdateVerticalOffsetCell(wndUnitGrid, nNewRowIndex, nVerticalOffset)
    end
...
function Nameplacer:InitUnitSelection(strUnitName, bUpdateGridSelection)
    ...
    local tPosSettings = tUnits[strUnitName]
...
function Nameplacer:OnAddUnit()
    ...
    local nVerticalOffset = tonumber(trim(wndInputBoxVerticalOffset:GetValue()))
...
function Nameplacer:OnSpinnerChanged(wndHandler, wndControl)
    ...
    local nVerticalOffset = wndHandler:GetData()
    ...
    local tUnitPosSettings = self.tUnits[self.strSelectedUnitName] or { nAnchorId = CombatFloater.CodeEnumFloaterLocation.Bottom, nVerticalOffset = nVerticalOffset - 1 }
    ...
    if (nVerticalOffset ~= tUnitPosSettings.nVerticalOffset) then
